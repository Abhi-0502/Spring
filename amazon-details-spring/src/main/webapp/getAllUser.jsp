        ...
        <tbody>
            <con:forEach var="user" items="${getAllUser}">
                <tr>
                    ...
                    <td>${user.getProductQuality()}</td>
                    <td>${user.getProductPrice()}</td>
                    <td>${user.getProductCategory()}</td>
                    <td>${user.getProductDescription()}</td>
                    <td>${user.getProductStock()}</td>
                    <td>${user.getProductBrand()}</td>
                    <td>${user.getProductWeight()}</td>
