...
<head>
    ...
    <title>Power Culture - Power Solutions</title>

    <!-- Meta Tags for SEO -->
    <meta name="description" content="Reliable UPS solutions, Data Centers, and Energy Efficiency for Maximum Uptime.">
    <meta name="keywords" content="UPS, Power Solutions, AI Data Center, Energy Audit, Batteries, PDU, KVM, STS, ATS">
    <meta name="author" content="Power Culture">
