...
<head>
    ...
    <title>Med-Sales E-Commerce</title>
    <style>
        /* General styles */
        body {
...
<body>
    <header>
        <h1>Med-Sales E-Commerce</h1>
        <div class="search-bar">
            <input type="text" placeholder="Search medical products...">
        </div>
...
<section class="categories">
    ...
    <footer>
        <p>&copy; 2025 Med-Sales E-Commerce. All Rights Reserved.</p>
